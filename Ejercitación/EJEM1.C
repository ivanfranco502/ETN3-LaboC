...
void main(void) {
	...
	clrscr(); //borra la pantalla
		...
		a la cual le suma los parametros*/
		printf("El resultado de multiplicaci¢n %i con %i es %i", a,b,multi(a,b));
		printf("\n");
		if(b==0){ //si b(denominador) es igual a 0
			printf("La divisi¢n por 0 no est  definida");
		}else{
		/*muestra el resultado de la division y
		llama a la funcion division
		a la cual le suma los parametros*/
			printf("El resultado de divisi¢n %i con %i es %.3f", a,b, divi(a,b));
		}
		printf("\n");
